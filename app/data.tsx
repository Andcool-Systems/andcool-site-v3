...
const bf_more = <><br /><br />Проект разрабатывался для практики в программировании, а так же из-за желания понять, как работает интерпретация языка изнутри.<br /><br />
...
const oauth_more = <><br /><br />Проект разрабатывался как замена сервису mc-oauth.com, так как на момент создания он был отключён.<br /><br />Вначале был создан серверный плагин на версию 1.20. При входе на сервер плагин генерировал 6-значный код, с которым ассоциировал никнейм и uuid зашедшего игрока.
