...
const ppl_more = (
    <>
        ...
        <br />
        <b>1. Telegram бот v1.0</b>{' '}
        <span style={{ color: 'gray', fontSize: '.9rem' }}>
            (02.06.2023 – 06.03.2024)
        </span>{' '}
        Первая реализация проекта в виде телеграм бота на Python и Aiogram 2. Он
        проработал 9 месяцев без значительных падений.
        <br />
        <br />
        <b>
            2.{' '}
        ...
        В связи со сложностью обновления старого бота был создан новый, где
        использовался Aiogram 3. Версия 2.0 имела обновлённый клавиатурный
        интерфейс и оптимизированный метод рендера.
        <br />
        <br />
        <b>
            3.{' '}
        ...
        Для охвата большей аудитории был создан сайт. Он почти полностью
        повторяет функционал второго бота за исключением некоторых нюансов. Сайт
        разработан на Next.Js.
        <br />
        <br />
        <b>
            4.{' '}
        ...
        [v2]{' '}
        <span style={{ color: 'gray', fontSize: '.9rem' }}>
            (30.05.2024 – 09.07.2024)
        </span>{' '}
        Вторая версия планировалась как полное переосмысление клиентского кода,
        для достижения большей производительности и читаемости кода. Она так и
        не была публично анонсирована.
        <br />
        <br />
        <b>
            5.{' '}
        ...
        Третья версия принесла с собой полную переработку как клиента, так и
        сервера. Была добавлена система аккаунтов, каждая повязка теперь имеет
        свою страницу, а главным нововведением является <b>мастерская</b>.
        Теперь любой желающий может создать свою повязку и загрузить её на сайт.
        <br />
        <br />
        <img
...
const next_cookies_more = (
    <>
        Cookie-файлы получаются на стороне сервера, а затем прокидываются до
...
const pplrp_more = (
    <>
        ...
        сайту. <br />
        Проведена полная переработка дизайна сайта, а так же реализованы функции
        рендера и предпросмотра моделей на стороне клиента, что значительно
        снизило нагрузку на сервер и сеть, увеличив скорость загрузки всего
        сайта.
        <br />
